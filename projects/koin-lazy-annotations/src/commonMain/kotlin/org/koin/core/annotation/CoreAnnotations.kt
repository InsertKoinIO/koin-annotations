...
/**
 * Koin definition annotation
 * Declare a type, a function as `lazy single` definition in Koin
 *
 * This will be placed in a lazy module versus [Single] which is placed in a regular module.
 */
@Target(AnnotationTarget.CLASS, AnnotationTarget.FUNCTION)
annotation class LazySingle(val binds: Array<KClass<*>> = [Unit::class], val createdAtStart: Boolean = false)
...
/**
 * Koin definition annotation
 * Declare a type, a function as `lazy factory` definition in Koin
 *
 * This will be placed in a lazy module versus [Factory] which is placed in a regular module.
 */
@Target(AnnotationTarget.CLASS, AnnotationTarget.FUNCTION)
annotation class LazyFactory(val binds: Array<KClass<*>> = [Unit::class])
